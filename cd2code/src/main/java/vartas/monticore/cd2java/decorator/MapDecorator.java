...
public class MapDecorator extends AbstractMethodDecorator<ASTCDAttribute>{
    ...
    public LinkedHashMap<String, String> getMethodSignatures(@Nonnull ASTCDAttribute cdAttribute){
        ...
        //Key and value
        String keyTypeArgumentName = CDGeneratorHelper.getMCTypeArgumentName(cdAttribute, 0);
        String valueTypeArgumentName = CDGeneratorHelper.getMCTypeArgumentName(cdAttribute, 1);
