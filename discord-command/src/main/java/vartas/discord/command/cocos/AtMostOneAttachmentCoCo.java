...
public class AtMostOneAttachmentCoCo implements CommandASTCommandCoCo, CommandInheritanceVisitor {
    protected int counter;
    public static final String ERROR_MESSAGE = "A command can have at most one attachment restriction.";
    @Override
    ...
    public void visit(ASTRestrictionName node){
        if(node.getRestriction() == ASTRestriction.ATTACHMENT)
            ++counter;
    }
}
