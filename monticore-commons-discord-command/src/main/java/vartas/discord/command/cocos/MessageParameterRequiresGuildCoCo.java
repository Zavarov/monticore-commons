...
public class MessageParameterRequiresGuildCoCo implements CommandASTCommandCoCo, CommandInheritanceVisitor {
    public static final String ERROR_MESSAGE = "Only guild commands can have message parameters.";
    ...
    public void visit(ASTParameterVariable node){
        if(node.getParameter() == ASTParameter.MESSAGE)
            hasMessage = true;
    }
}
