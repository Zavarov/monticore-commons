...
import vartas.discord.parameter._symboltable.TextChannelParameterSymbol;
...
public class TextChannelParameter2ArgumentSymbol extends TextChannelParameterSymbol implements Parameter2ArgumentInterface<TextChannel>{
    ...
    public TextChannelParameter2ArgumentSymbol(String name, ASTArgumentType argument) {
        super(name);
