...
public class GuildArgumentSymbolTest extends AbstractArgumentSymbolTest {
    @Parameterized.Parameters
    public static Object[] data() {
        return new Object[] {
                "example.guild \""+guildName+"\"",
                "example.guild "+guildName,
                "example.guild "+guildId
        };
    }
    ...
    public void testAccept(){
        ...
        assertThat(symbol.accept(message)).contains(guild);
    }
}
