...
public class ArithmeticExpressionsValueCalculator extends MathDelegatorVisitor {
    /**
    ...
    protected ArithmeticExpressionsValueCalculator(){
        setMathVisitor(new ArithmeticExpressionsValueCalculatorSubCalculator());
    ...
    private class ArithmeticExpressionsValueCalculatorSubCalculator implements MathVisitor {
