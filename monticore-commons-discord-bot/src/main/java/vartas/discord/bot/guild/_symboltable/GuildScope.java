...
public class GuildScope extends GuildScopeTOP {
    public GuildScope() {
        super();
        this.name = Optional.empty();
    }

    public GuildScope(boolean isShadowingScope) {
        this.shadowing = isShadowingScope;
        this.name = Optional.empty();
    }

    public GuildScope(IGuildScope enclosingScope) {
        this(enclosingScope, false);
    }

    public GuildScope(IGuildScope enclosingScope, boolean isShadowingScope) {
