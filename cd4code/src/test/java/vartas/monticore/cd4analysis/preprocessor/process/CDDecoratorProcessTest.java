...
public class CDDecoratorProcessTest extends AbstractCDProcessTest {
    CDDecoratorProcess process;

    @BeforeEach
    public void setUp(){
        super.setUp();
        process = new CDDecoratorProcess(glex);
    }
    ...
    public void testDecorateCache(String returnName, String methodName, @ConvertWith(CSV2StringArray.class) String[] parameters){
        ASTCDDefinition ast = getCDDefinition("vartas.monticore.cd4code.Cache");
        ast.accept(process);
    ...
    public void testDecorateCollection(String returnName, String methodName, @ConvertWith(CSV2StringArray.class) String[] parameters){
        ASTCDDefinition ast = getCDDefinition("vartas.monticore.cd4code.List");
        ast.accept(process);
    ...
    public void testDecorateMap(String returnName, String methodName, @ConvertWith(CSV2StringArray.class) String[] parameters){
        ASTCDDefinition ast = getCDDefinition("vartas.monticore.cd4code.Map");
        ast.accept(process);
    ...
    public void testDecorateObject(String returnName, String methodName, @ConvertWith(CSV2StringArray.class) String[] parameters){
        ASTCDDefinition ast = getCDDefinition("vartas.monticore.cd4code.Optional");
        ast.accept(process);
