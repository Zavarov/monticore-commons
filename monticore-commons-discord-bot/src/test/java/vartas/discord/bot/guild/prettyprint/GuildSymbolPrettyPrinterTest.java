...
public class GuildSymbolPrettyPrinterTest extends AbstractGuildTest {
    File reference;
    IndentPrinter printer;
    GuildSymbolPrettyPrinter prettyPrinter;
    ...
    public void setUp(){
        ...
        prettyPrinter = new GuildSymbolPrettyPrinter(printer);
    }
